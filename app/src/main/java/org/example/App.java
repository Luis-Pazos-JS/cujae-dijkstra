    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nVector; i++){
            ...
            for(int j = 0; j < vertex.getEdgeList().size();j++){
                ...
                table[i+1][pos+1] = edge.getDestiny().getInfo()  + "-" + edge.getWeight();
            }
        }
